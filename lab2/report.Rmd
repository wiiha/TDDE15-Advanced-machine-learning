...
Smoothing is better than filtered and most probable path since smooth uses all observations (previous and coming) while filtered only uses previous observations.
...
From the presented calculations above it can be concluded that more observations does not equal better accuracy of where the robot is.
